...
const tourSchema = new mongoose.Schema({
    name: {
        ...
        validate: [
            function (val) {return validator.isAlpha(val, ['en-US'], {ignore: " "})}, 
    ...
    difficulty: {
        ...
        enum: {
            ...
            message: "Group size is either easy, medium or difficult"
    }
    },
    ratingsAverage: {
        type: Number,
    ...
    priceDiscount: {
        type: Number,
        validate: {
            message: "priceDiscount ({VALUE}) cannot be higher than price",
